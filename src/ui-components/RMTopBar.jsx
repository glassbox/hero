...
export default function RMTopBar(props) {
  ...
  return (
    <Flex
      ...
      {...rest}
      {...getOverrideProps(overrides, "RMTopBar")}
    >
      <Flex
        gap="2px"
        direction="row"
      ...
      >
        <Image
          ...
          padding="0px 0px 0px 0px"
          objectFit="cover"
          {...getOverrideProps(overrides, "rm-logo-black@0,5x")}
        ></Image>
      </Flex>
      <Flex
        gap="40px"
        ...
        position="relative"
        padding="0px 0px 0px 0px"
        {...getOverrideProps(overrides, "Frame 32134553609")}
      >
        <Text
          fontFamily="Inter"
          fontSize="16px"
          ...
          whiteSpace="pre-wrap"
          children="Workspace"
          {...getOverrideProps(overrides, "Workspace")}
        ></Text>
        <Text
          fontFamily="Inter"
          fontSize="16px"
          ...
          whiteSpace="pre-wrap"
          children="Workgroups"
          {...getOverrideProps(overrides, "Workgroups")}
        ></Text>
        <Text
          fontFamily="Inter"
          fontSize="16px"
        ...
        <Text
          ...
          whiteSpace="pre-wrap"
          children="Workitems"
          {...getOverrideProps(overrides, "Workitems")}
        ></Text>
      </Flex>
      <Flex
        gap="32px"
        ...
        position="relative"
        padding="0px 0px 0px 0px"
        {...getOverrideProps(overrides, "Frame 32134553614")}
      >
        <SearchField
          display="flex"
          gap="8px"

...
export default function WorkItemCard1(props) {
  const { Title, todo, overrides, ...rest } = props;
  return (
    <Flex
      gap="0"
      direction="column"
      ...
      {...rest}
      {...getOverrideProps(overrides, "WorkItemCard1")}
    >
      <Flex
        gap="16px"
        direction="column"
        ...
        >
          ...
          >
            <Text
              ...
              whiteSpace="pre-wrap"
              children={todo?.name}
              {...getOverrideProps(overrides, "Campaign")}
            ></Text>
            <Text
              fontFamily="Inter"
              fontSize="16px"
